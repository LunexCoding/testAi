...
namespace OrderApprovalSystem.Core.UI
{
    ...
    public static class WindowSizing
    {
        ...
        private static void WmGetMinMaxInfo(IntPtr hwnd, IntPtr lParam)
        {
            ...
            if (monitorContainingApplication != System.IntPtr.Zero)
            {
                ...
                mmi.ptMinTrackSize.x = 300;                                                             //minimum drag X size for the window
                mmi.ptMinTrackSize.y = 200;                                                             //minimum drag Y size for the window
