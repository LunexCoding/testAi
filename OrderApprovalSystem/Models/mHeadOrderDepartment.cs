...
namespace OrderApprovalSystem.Models
{
    public class mHeadOrderDepartment : mBaseOrderApproval
    {
        ...
        /// <summary>
        /// Согласовывает текущий заказ от имени начальника отдела заказов и создаёт следующий шаг.
        /// </summary>
        /// <remarks>
        /// Алгоритм формирования иерархии (ParentID) нового шага:
        /// <list type="number">
        /// <item>
        ...
        ///   Если найдена — новый шаг становится дочерним к ней.
        ///   Иначе — берёт ParentID текущего шага (остаётся на том же уровне иерархии).
        /// </item>
        /// <item>
        ///   <b>IsRework = false (обычное согласование):</b>
        ///   Если текущий шаг внутри цикла доработки (ParentID != null) и следующий получатель —
        ...
        /// <list type="bullet">
        /// <item>IsRework=true + родитель тоже IsRework: родительский под-цикл переносится под новый шаг.</item>
        /// <item>Циклическая ссылка обнаружена: новый шаг меняется местами с родителем (swap).</item>
        /// </list>
        /// </remarks>
