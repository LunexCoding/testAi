...
namespace OrderApprovalSystem.Models
{
    public class mOrderManager : mBaseOrderApproval
    {
        ...
        /// <summary>
        /// <summary>
        /// Согласование технологического заказа менеджером заказов.
        /// Обновляет текущую запись, создаёт следующий шаг и перестраивает иерархию ParentID.
        /// </summary>
        /// <remarks>
        ...
        ///   Ищет самую верхнюю запись с отклонением для следующего получателя.
        ///   Если найдена — новый шаг становится дочерним к ней.
        ///   Иначе — берёт ParentID текущего шага.
        /// </item>
        /// <item>
        ///   <b>IsRework = false (обычное согласование):</b>
        ///   Проверяет, возвращаемся ли к тому, кто ранее отклонил.
        ///   Если да — остаёмся в его цикле (ParentID = ID отклоняющей записи).
